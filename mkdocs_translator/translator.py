...
class DocumentTranslator:
    ...
    def __init__(
        ...
        if system_prompt is None:
            terminology, _ = load_terminology().for_language(self.target_lang)
            system_prompt = build_prompt_bundle(self.profile, terminology).system_prompt
    ...
    def translate_file(
        ...
        **_legacy_progress_args,
        ...
        except (OSError, TranslationError, ValidationError, UnicodeError, ValueError) as exc:
